...
# Append the traces to the fig and assign coordinates by Row and Column
fig.append_trace(trace1,1,1)
fig.append_trace(trace2,1,2)
fig.append_trace(trace3,1,3)

fig['layout'].update(title='Temps for 3 cities') # How to update and access the layout title through fig

pyo.plot(fig, filename='heatmap-multiplot.html')
